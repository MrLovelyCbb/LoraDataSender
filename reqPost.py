...
if __name__ == '__main__':
    ...
    try:
        t1 = threading.Thread(target=loop_send_req, args=("004A77012400D871", 200000,))
        t2 = threading.Thread(target=loop_send_req, args=("004A77012400D872", 200000,))
        t3 = threading.Thread(target=loop_send_req, args=("004A77012400D873", 200000,))
        t4 = threading.Thread(target=loop_send_req, args=("004A77012400D874", 200000,))
        t5 = threading.Thread(target=loop_send_req, args=("004A77012400D875", 200000,))
